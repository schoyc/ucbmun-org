...
", "Humblebrag alert: I do attend UC Berkeley and despite my best efforts have not [yet] been kicked out yet. I never figured out why anyone would care about their CD or Chair’s personal biography, but I suppose I am awesome so here is just that. I grew up in the town of New Canaan, Connecticut a beautiful oasis in between the rolling hills of New England and the gold paved city of New York. I am a second year history major and have been doing Model UN since its inception in the early 1950s. I also do a bit of this and that on the side, mostly writing, reading, and merry making. ", "The committee Rahim (your wonderful chair) and I have devised is on the topic of Obama’s Cabinet in 2012, as you most likely already knew. While I have spent my whole life in America, Rahim has been nothing short of a globetrotter. Hopefully this knowledge can help to assuage some concerns you may have if you were raised outside of the states! We hope each delegate brings his or her diverse range of perspectives. Another bit of advice is to not expect this committee to follow the course of history. The most successful delegates will come into this committee with a solid understanding of Obama’s first and second term, but prepared to handle any divergences from the actual course of events. To you all: best of luck and even better luck in your life’s pursuits. ", "Cheers,", "Ish Farooqui"],
        ...
        "darkweb" => {name: "Conquering the Web:",
                      ...
                      chair_letter: ["Dear Delegates,", "It brings me great pleasure to welcome you to the Crisis Committee: “The Dark Net” at UC Berkeley Model United Nations XIX. My name is Bhavna Gopal, and I am so honored and excited to serve as your head chair for what I’m sure will be a truly unforgettable weekend of debate and fun! ", "It brings me great pleasure to welcome you to the Crisis Committee: “The Dark Net” at UC Berkeley Model United Nations XIX. My name is Bhavna Gopal, and I am so honored and excited to serve as your head chair for what I’m sure will be a truly unforgettable weekend of debate and fun! ", "Chairing a committee in which I can use my technical expertise is nothing short of a dream come true for me! Our committee is truly unconventional in that both Steven and I have worked hard to make sure we can utilize the internet and technology to the maximum in committee session i.e: most of the communication delegates will do with eachother will be online. In my opinion the true heart and soul of this committee lies in the beauty of the online world and a language that I hope you, as delegates will take advantage of to the maximum! ", "I have no doubts that this committee will be fantastic and please don’t hesitate to contact me with any questions. Looking forward to meeting all of you! ", "Sincerely", "Bhavna Gopal"],
...
", "Best Regards, ", "Kristine Kousherian"]
      ...
      "zanu" => {name: "Zimbabwe African National Union (ZANU)",
                 ...
                 chair_letter: ["Dear Delegates,", "Welcome to the ZANU committee in what is sure to be one of our greatest JCCs ever – the Battle for the Heart of Africa! My name is Amay Gupta and I’m honored and excited to be your chair for this committee. I’m a fourth-year Economics major, and have been in UCBMUN all four years of my undergraduate career. For those of you that care, outside of MUN, I am also involved in healthcare nonprofit work in my hometown of Los Angeles; I also enjoy investing in the stock market, international finance, and all things related to luxury sports cars (I see you S65 AMG coupe). Before UCBMUN, I was also involved in high school forensics, so I’ve always enjoyed debating international policy issues. I vice-chaired the JCC last year (France won, so don’t listen to former UCBMUN attendees if they say otherwise), the UNSC the year before, and was on the crisis team for the JCC my freshman year. This is unfortunately the last conference I will get to work on, but I am still very excited to finally have delegates of my own who will provide engaging debate (and suck up to me if I’m lucky).", "This committee will allow your imaginations to be reflected in committee and has an incredible amount of power. I expect you to use the resources allocated to you by crisis to destroy the government of Ian Smith. As a MUN delegate and a previous debater, I will be judging you on a mix of adequate research, innovative crisis engagement, solid and logical rebuttals, and great public speaking skills. I believe each delegate in this committee will develop his or her skills in this committee, which is why I love MUN so much and why I am so excited to see you all contribute. I expect each delegate to come to this committee with an array of knowledge about the subject because your decisions in this committee have the ability to re-write history for the better. I will very much despise the members of the committee whose primary focus is sabotage rather than working towards defeating ZAPU and the white supremacy that has plagued Rhodesia for too long. Please make sure your arguments or opening statements are prepared beforehand because we will hit the ground running with crises.", "If you have any questions, feel free to e-mail me and I am so excited to see you all in the spring!", "Best,", "Amay Gupta"],
